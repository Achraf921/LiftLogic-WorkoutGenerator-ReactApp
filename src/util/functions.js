//! THE FOLLOWING ALGORITHM WAS NOT WRITTEN BY ME BUT DEBUGGED BY ME.

import { EXERCISES, SCHEMES, TEMPOS, WORKOUTS } from "./LLS.js"
const exercises = exercisesFlattener(EXERCISES)

export function generateWorkout(muscles,workout,goal) {
